...
@section('content')
                ...
                <div class="d-flex flex-wrap align-items-center">
                    <div class="widget-data">
                        <div class="h4 mb-0 text-success">
                            Rp {{ number_format($statistik['pembelian_bulan_ini'] ?? 0, 0, ',', '.') }}
                        </div>
                        <div class="weight-600 font-14">Pembelian Bulan Ini</div>
                    </div>
                    <div class="widget-icon">
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 mb-30">
            <div class="card-box height-100-p pd-20">
                <div class="d-flex flex-wrap justify-content-between align-items-center pb-0">
                    <div class="h5 mb-0">Statistik Bahan Baku & Produk</div>
                </div>
                <div class="mt-4">
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="icon-box bg-success mr-3">
                                    <i class="icon-copy dw dw-shopping-bag"></i>
                                </div>
                                <div>
                                    <div class="h4 mb-0">{{ $statistik['total_produk'] ?? 0 }}</div>
                                    <div class="font-12">Total Produk</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="icon-box bg-warning mr-3">
                                    <i class="icon-copy dw dw-truck"></i>
                                </div>
                                <div>
                                    <div class="h4 mb-0">{{ $statistik['total_supplier'] ?? 0 }}</div>
                                    <div class="font-12">Total Supplier</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 mb-3">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Owner Dashboard script dimulai...');
