                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item edit-btn" href="#" data-id="{{ $p->id }}">
                        ...
                        <div class="form-group">
                            ...
                            <div id="komposisi-container">
                                <div class="komposisi-item row mb-2">
                                    <div class="col-md-6">
                                        <select class="form-control select2-bahan-baku" name="komposisi[0][bahan_baku_id]"
                                            required>
